...
// Defining a local interface here lets tests inject a mock without depending on
// the concrete *agentgraph.Helper type and its NATS infrastructure.
...
// error, because the marshal failure is a programming error in the executor
